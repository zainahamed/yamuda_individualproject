...
class _EditPersonalState extends State<EditPersonal> {
  ...
  void initializeUser() async {
    ...
    if (user != null) {
      ...
      emgContactController.text = user!.emgContact ?? "";
      emgNameController.text = user!.emgName ?? "";
      emgEmailController.text = user!.emgEmail ?? "";
      emgRelationshipController.text = user!.emgRelationship ?? "";
    }
  }
